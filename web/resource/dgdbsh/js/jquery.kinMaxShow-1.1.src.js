	...
	$.fn.kinMaxShow = function(user_options){
			...
			var default_options = {
						...
						button:{
								...
								normal:{width:'30px',height:'3px',lineHeight:'3px',right:'42%',bottom:'20px',fontSize:'10px',background:"#788a96",color:"#666666",textAlign:'center',marginRight:'6px',fontFamily:"Verdana",float:'left'},
								//当前 按钮样式
								focus:{background:"#ec2a1a",color:"#000000"}
							},
			...
			k.onload = function(){
				//设置容器尺寸 并且暂时隐藏内容部分
				$(k.self).css({width:'1003',height:options.height,overflow:'hidden',position:'relative'}).children('div').addClass(k.prename+'image_item').hide();
				//初始化
				k.init();
