...
/**
 * Simple http my_request for retrieving external files (e.g. text tracks)
...
vjs.MediaTechController.prototype.features = {
  ...
  // Resizing plugins using my_request fullscreen reloads the plugin
...
vjs.Flash = vjs.MediaTechController.extend({
  ...
  init: function(player, options, ready){
    ...
    // The only downside of this it seems to trigger another http my_request to the original page (no matter what's put in the href). Not sure why that is.
