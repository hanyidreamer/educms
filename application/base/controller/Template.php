...
class Template extends Controller
{
    /**
     * 当前模板路径
     * @param array $public_array
     * @return string
     * @throws \think\exception\DbException
     */
    public function path($public_array = array('public_header'=>'/public/header','public_footer'=>'/public/footer'))
    {
        // 当前操作位置
        ...
        if(!empty($my_template['id'])){
            ...
            if($module_name == 'admin'){
                ...
                $template_path = strtolower($template_path);
                $template_public_header = '/' .$site_template_name .'/' . $module_name .'/public/header';
                $template_public_footer = '/' .$site_template_name .'/' . $module_name .'/public/header';
                $this->assign('public_header',$template_public_header);
                $this->assign('public_footer',$template_public_footer);
            }else{
                ...
                $template_public_header = '/' .$template_name . $client_path . $public_array['public_header'];
                $template_public_footer = '/' .$template_name . $client_path . $public_array['public_footer'];
                $this->assign('public_header',$template_public_header);
                $this->assign('public_footer',$template_public_footer);
            }
        }
