...
use think\Request;
use app\common\model\StudentCategory as StudentCategoryModel;

class StudentCategory extends AdminBase
{
    /**
    ...
    public function save(Request $request)
    {
        ...
        if ($data->save()) {
            $this->success('保存成功','/admin/student_category/index');
        } else {
            $this->error('操作失败');
        }
    ...
    {
        // 获取网站信息
        $data_list = StudentCategoryModel::get($id);
    ...
    public function update(Request $request)
    {
        ...
        $user = StudentCategoryModel::get($post_id);
    ...
    {
        $data = StudentCategoryModel::get($id);
        if ($data) {
            $data->delete();
            $this->success('删除分类成功', '/admin/student_category/index');
        } else {
