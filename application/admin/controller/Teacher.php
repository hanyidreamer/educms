...
use think\Request;
use app\base\model\Teacher as TeacherModel;
use app\base\model\TeacherCategory;
...
class Teacher extends Base
{
    public function index(Request $request)
    {
        ...
        foreach ($data_list as $data){
            ...
            $category_data = TeacherCategory::get($category_id);
    ...
    public function create()
    {
        ...
        // 获取网站分类列表
        $category_data = new TeacherCategory();
    ...
    public function save(Request $request)
    {
        ...
        if ($data->save()) {
            $this->success('保存成功','/admin/teacher/index');
        } else {
            $this->error('操作失败');
        }
    }
    ...
    public function edit($id)
    {
        ...
        $this->assign('site_id',$site_id);
        // 获取当前分类id
        $categorg_id_info = TeacherModel::get($id);
        $categorg_id = $categorg_id_info['category_id'];

        // 获取信息
        $data_list = TeacherModel::get($id);
        ...
        $my_categorg_data = TeacherCategory::get($categorg_id);
    ...
    public function update(Request $request)
    {
        ...
        if ($data->save()) {
            $this->success('更新成功', '/admin/teacher/index');
        } else {
            $this->error('操作失败');
        }
    ...
    public function delete($id)
    {
        ...
        if ($data) {
            $data->delete();
            $this->success('删除广告成功', '/admin/teacher/index');
        } else {
